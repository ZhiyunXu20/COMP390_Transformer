...
| fast_add_lr3e3 | small_try | additive | scoring | 21.56 ± 0.42 (n=3) | 44.69 ± 0.47 (n=3) | 42.70 ± 0.46 (n=3) | 0.5776 ± 0.0061 (n=3) | 3 | p=0.0002 | 0.89028 | 2500 | 30845232 | 1831.23 | 51824.2 | ok | 3 seeds from `results/ablation_per_seed.csv`; representative `runs/fast_add_lr3e3_s1/test_eval` metrics (notes blurbs): BLEU=21.88, chrF++=43.09, COMET=0.5735. n_heads=4 |
...
| var_local_window_a23_retrain | small_try | local_window | connectivity | 16.82 (n=1) | 38.37 (n=1) | 36.69 (n=1) | 0.5231 (n=1) | 1 |  | 0.879923 | 2500 | 30442800 | 1110.32 | 10700.4 | ok | (single seed; not statistically tested vs fast_dot) n_heads=4 |
